        ...
        for m in self.modules():
            if isinstance(m, nn.BatchNorm3d):
                ...
                if m.bias is not None:
                    m.bias.data.zero_()
            # TODO !!!!!! The parameter initialization for the supernet must be performed externally all at once, rather than within the operator. Otherwise, the seed will become invalid !!!!!!
